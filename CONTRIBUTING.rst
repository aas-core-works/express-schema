...
.. _create a new issue: https://github.com/aas-core-works/express-schema/issues/new
...
Once you activated the virtual environment, you can install the project in the environment as well as the development dependencies using ``pip``:
...
.. code-block::python
    ...
    from express_schema.something import (
...
Development Scripts
===================
The scripts used to generate code or tests live in `dev/dev_scripts/`_.
...
.. _dev/dev_scripts/: https://github.com/aas-core-works/express-schema/tree/main/dev/dev_scripts
