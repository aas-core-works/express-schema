...
def main() -> None:
    ...
    metadata = cast(PackageMetadata, importlib.metadata.metadata("express-schema"))

    # Check version
    init_version = express_schema.__version__
    ...
    # Check authors
    init_authors = [author.strip() for author in express_schema.__author__.split(",")]
    ...
    init_status = express_schema.__status__
    ...
    # Check license
    init_license = express_schema.__license__
